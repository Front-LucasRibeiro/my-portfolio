...
function InfoContratar({ formulario }) {
  ...
  return (
    <>
      <p className={style.planos__info}>Após realizar o pagamento, preencha os dados iniciais para a contratação do serviço <a href={formulario} target="_blank" rel="noreferrer noopener">nesse formulário</a>.</p>
