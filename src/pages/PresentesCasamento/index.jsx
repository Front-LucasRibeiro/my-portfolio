import style from 'pages/PresentesCasamento/styles.module.scss';


function PresentesCasamento() {
  return (
    <div>
      <main className={style.main}>
        <h1>Site Presentes para Casamento</h1>

        <section className={style.descricao}>
          <p>O Site Presentes para Casamento é uma loja virtual, onde seus convidados podem utilizar os presentes cadastrados ou cadastrar novos presentes para enviar aos seus convidados, o cliente cadastra uma conta bancaria PagSeguro, Pix ou Transferência Bancária e recebe o valor de seus presentes em dinheiro.</p>
...
export default PresentesCasamento;